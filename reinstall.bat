...
rem set confhome_cn=https://cnb.cool/kelryry/reinstall/-/git/raw/main
set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/kelryry/reinstall/main
